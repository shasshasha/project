        ...
        if($blog)
        {
           ...
           <div class="blog_main">     
               <form action="ss_change.php" method="post" enctype="multipart/form-data">                     
                    ...
                    echo"<p class='join4'>프로필사진</p><input type='file' name='upfile[]' class='join3' value='$row[file_copied_0]'><Br></Br>";
         ...
         ?>
            ...
            <div class='blog_main'>
                <input type="button" id="write_button"onclick="write_button()" value="글쓰기">
                        ...
                        if($result)
                            ...
                            while($row=mysql_fetch_array($result))//--이미지출력
                            {
                                $count=$row[count];
            ...
            $('.login_table').css('opacity','0');
             ...
             echo"<script>
            $(function(){
                $('#login_table').css('margin-top','-1200px');
                });
            </script>";
        }
        ?>
